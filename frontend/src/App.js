...
import backgroundImage from "./assets/logo_psico_abuelos_full_hd.jpeg";
...
const CenterButton = styled(Link)`
  ...
  background: linear-gradient(
    145deg,
    rgba(179, 157, 219, 1) 0%,
    rgba(103, 58, 183, 1) 100%
  );
  border: 1px solid
    ${(props) => props.theme?.palette?.primary?.dark || "#673ab7"};
...
const Spinner = styled.div`
  ...
  height: 50px;
  border: 8px solid
    ${(props) => props.theme?.palette?.primary?.light || "#b39ddb"};
  border-top: 8px solid
    ${(props) => props.theme?.palette?.primary?.main || "#673ab7"};
  border-radius: 50%;
  ...
  <Router>
    ...
    <ContentWrapper>
      ...
      <Routes>
        ...
        <Route path="/contrato1" element={<Contrato1 />} />{" "}
        {/* Nueva ruta para Contrato1 */}
        <Route path="/contrato2" element={<Contrato2 />} />{" "}
        {/* Nueva ruta para Contrato2 */}
      </Routes>
    </ContentWrapper>
  </Router>
);
